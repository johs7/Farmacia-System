...
namespace WindowsFormsApp1.Formularios
{
    public partial class FormMain : Form
    {
        ...
        {
            Formularios.FormCuentas fm2=new Formularios.FormCuentas();
            fm2.ShowDialog();
        }

        private void BtnVendedores_Click(object sender, EventArgs e)
        {
            Formularios.FormVendedores fm2 = new Formularios.FormVendedores();
            fm2.ShowDialog();
        }

        private void BtnClientes_Click(object sender, EventArgs e)
        {
            Formularios.FormClientes fm2 = new Formularios.FormClientes();
            fm2.ShowDialog();
        }

        private void BtnMedic_Click(object sender, EventArgs e)
        {
            Formularios.FormMedicamentos fm2 = new Formularios.FormMedicamentos();
            fm2.ShowDialog();
        }
