...
namespace WindowsFormsApp1.Formularios
{
    ...
    public partial class FormCuentas : Form
    {
        ...
        private void FormCuentas_Paint(object sender, PaintEventArgs e)
        {
        ...
        private void FormCuentas_ResizeEnd(object sender, EventArgs e)
        {
            this.Invalidate();
        }

        private void FormCuentas_SizeChanged(object sender, EventArgs e)
        {
            this.Invalidate();
        }

        private void FormCuentas_Activated(object sender, EventArgs e)
        {
            this.Invalidate();
        }
